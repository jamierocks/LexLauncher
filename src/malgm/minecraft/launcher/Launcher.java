...
public class Launcher {
	...
	private final static String launcherLogFile = "LauncherLog.txt";
    ...
    public static void main(String []args) {
        ...
        if (new File(Utils.getLauncherDirectory().toString(), launcherLogFile).exists()) {
            new File(Utils.getLauncherDirectory().toString(), launcherLogFile).delete();
        }
